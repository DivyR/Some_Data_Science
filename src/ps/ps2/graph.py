...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        ...
        self.totalDist = total_distance
        self.outdoorDist = outdoor_distance
    ...
    def __str__(self):
        # leverage Edge.__str__ and append modifications
        return (
            Edge.__str__(self)
            + " "
            + "({}, {})".format(self.totalDist, self.outdoorDist)
        )
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        if not (self.has_node(srcNode) and self.has_node(edge.get_destination())):
            raise ValueError
        self.edges[srcNode].append(edge)
